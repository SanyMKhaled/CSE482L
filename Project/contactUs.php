...
<div class="row">
  <div class="column">
    <div class="card">
      ...
      <div class="container">
        ...
        <p><a href="mailto:sany.khaled@northsouth.edu"><button class="button">Contact</button></p>
      </div>
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      ...
      <div class="container">
        ...
        <p><a href="mailto:fatema.kishwar@northsouth.edu"><button class="button">Contact</button></p>
      </div>
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="/w3images/team3.jpg" alt="Sate Israq Nawar Dipro" style="width:100%">
      <div class="container">
        <h2>Sate Israq Nawar Dipro</h2>
        <p class="title">ID : 1530363642</p>
        <p><a href="mailto:sate.dipro@northsouth.edu"><button class="button">Contact</button></p>
      </div>
    </div>
  </div>
</div>
